angular.module("app")
    .controller('travelModeController', function ($rootScope, $timeout, $q, $scope) {
        console.log("travelModeController");
         ...
         *!/
         ...
         if ($rootScope.edge[$rootScope.currentIndex].preference !== undefined) {
         console.log("getSelectedText in if");
         console.log($rootScope.edge[$rootScope.currentIndex].preference);
         return $rootScope.edge[$rootScope.currentIndex].preference;
         } else {
